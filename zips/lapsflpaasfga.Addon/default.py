...
nome_contador = "lapsflpaasfga-Addon"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| ADDON EXEMPLO|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Só mexe ae porra"
...
def resolver(link,regex):
    #xbmcgui.Dialog().ok('[B][COLOR white]AVISO[/COLOR][/B]',str(regex))
...
def kill_kodi():
    dialog = xbmcgui.Dialog()
    link = dialog.select('[B][COLOR white]FINALIZANDO INSTALAÇÃO DO ELEMENTUM[/COLOR][/B]', ['[COLOR white]SIM POR FAVOR! [/COLOR][COLOR orange]|[/COLOR] [COLOR lime]FORÇAR FECHAR[/COLOR]','[COLOR white]NÃO POR FAVOR! [/COLOR][COLOR orange]|[/COLOR] [COLOR red]NÃO CANCELAR[/COLOR]'])    
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    ...
    "[B][COLOR white]EXEMPLO - [/COLOR] NOME 2 [/B]",
    "[B][COLOR white]EXEMPLO - [/COLOR] NOME 3 [/B]",
    "[B][COLOR white]EXEMPLO - [/COLOR] ENTRAR NO ADD-ON [/B]"])    
...
#Configurações
    ...
    xbmcgui.Dialog().ok('[B][COLOR red]AVISO IMPORTANTE![/COLOR][/B]','[B][COLOR orange]|[/COLOR][/B][COLOR white] POR FAVOR SAIR DO ADD-ON E ENTRE NOVAMENTE,[B] [COLOR orange]|[/COLOR][/B] PARA ATUALIZAR AS CONFIGURAÇÕES![B] [COLOR orange]|[/COLOR][/B]')
    xbmc.executebuiltin("XBMC.Container.Refresh()")
